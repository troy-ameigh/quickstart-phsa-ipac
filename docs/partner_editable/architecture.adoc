...
** A function to retrieve and process Ground Truth output data. It sends cases with no decision to the partitioned data bucket and initiates another review job in Ground Truth. It deposits cases labeled as confirmed infections to a reporting S3 bucket.
