...
. Sign in to your AWS account, and choose the following option to launch the AWS CloudFormation template. For more information, see link:#_deployment_options[Deployment options] earlier in this guide.

[cols="2,1"]
|===
^|http://qs_launch_permalink[Deploy {partner-product-name} into a new VPC on AWS^]
^|https://fwd.aws/EPjJ5?[View template^]
